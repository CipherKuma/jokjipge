...
import { createWalletClient, createPublicClient, http, parseEther, formatEther, parseUnits, formatUnits, encodeFunctionData, type Chain } from 'viem'
import { privateKeyToAccount } from 'viem/accounts'
import { sepolia, arbitrumSepolia, avalancheFuji } from 'viem/chains'
...
const NETWORKS = {
  'verychain': {
    ...
    explorer: 'https://www.veryscan.io',
    nativeSymbol: 'VERY',
  },
  'sepolia': {
    chain: sepolia,
...
async function main() {
  ...
  if (args.length < 2) {
    ...
    console.log('')
    console.log('Networks: verychain, sepolia, arb-sepolia, fuji')
