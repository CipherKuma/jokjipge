...
**Problem:** Claude gets stuck when trying to deploy contracts because it doesn't know where to find the private key with funds for deployment on VeryChain.
...
- All deployments happen on **VeryChain Mainnet** (chain ID: 4613)
