...
export function TokenIcon({ 
  ...
  const generateGradient = (symbol: string) => {
    // Use theme-aware gradient combinations
    const colors = [
  ...
  if (!fallback) {
    return (
      <div className={cn('rounded-full bg-muted', sizeClasses[size], className)} />
    )
  }
  ...
  return (
    <div
      className={cn(
        'rounded-full flex items-center justify-center font-medium text-foreground bg-gradient-to-br',
        sizeClasses[size],
