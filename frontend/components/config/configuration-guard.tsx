              ...
              <div>
                ...
                <div className="grid gap-2">
                  {recommendedVars.map((varName) => (
                    <div key={varName} className="flex items-center justify-between p-3 rounded-lg border bg-warning/10">
                      <code className="text-sm font-mono">{varName}</code>
              ...
              {serverValidation ? (
                <div className="space-y-3">
                  ...
                  {serverValidation.warnings.length > 0 && (
                    <div className="border border-warning/30 rounded-lg p-3 bg-warning/10">
                      <h4 className="font-medium text-sm text-warning mb-2">Warnings</h4>
